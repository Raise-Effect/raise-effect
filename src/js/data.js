  ...
  render: function() {
    return (
        <div>
            ...
            <p>
            The self sufficiency study has a lot of great information about what it is like to live in this state, as an individual or as a parent,
            with detailed granular information about the various compositions of a household. But in thinking about the effect of an increase in the
            state minimum wage, it is helpful to look at the numbers of people that are impacted. It’s a challenge to make those comparisons though,
            because the census data does not reflect the granularity of the self-sufficiency study in terms of household composition.
            </p>
            <h3>Problem 1: the definition of family</h3>
            <p>
            ...
            <p>
                Census data groups people together differently. Gender of the head of household and how the household members are related matter in the census definition of
                family. A non-family household can have any number of unrelated individuals of any age. A family household must have at least two people who share a familial
                relationship (whether by marriage or by birth). Furthermore, family households are broken into three categories: married, male head of household with no wife
                present, and female head of household with no husband present. Each of those three divisions can be broken into family households either with or without own children
            ...
            <p>
                ...
                are an aggregate of ten self-sufficiency study family types which equate to married families with own children present. So to relate population numbers, in terms of number
                of households, to the self-sufficiency study family types, it was necessary to develop a complex weighting system.
            </p>
            <p>
            ...
            <p>
                This doesn’t account for the fact that there are a small number of non-family households in Oregon with children present. It also doesn’t account for the fact that some of the unmarried households may have more than one adult contributing income towards the livelihood of the household.
            </p>
            ...
            <h3>Problem 2: Identifying low income households</h3>
            <p>
                ...
                families, and all married households with children making less than $39,999 were included as low income married parent families. Those breakpoints were chosen because an annual minimum wage at the current Oregon rate of 9.25 equates to $19,536,

import nv from "nvd3";
import d3 from "d3";
import {bullet as chamber} from "./bullet";
...
export function bulletChart() {
    ...
    function chart(selection) {
        selection.each(function(d, i) {
            ...
            var x1 = d3.scale.linear()
                .domain([0, Math.max(rangez[0], markerz[0], measurez[0],[110000])])  // TODO: need to allow forceX and forceY, and xDomain, yDomain
    ...
    bullet.dispatch.on('elementMouseover.tooltip', function(evt) {
      var parts = evt.value.toString().split(".");
